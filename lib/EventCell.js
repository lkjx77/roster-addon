...
var EventCell =
  ...
  (function(_React$Component) {
    ...
    _proto.render = function render() {
      ...
      var title = accessors.title(event) // let tooltip = accessors.tooltip(event)
      ...
      var userProps = getters.eventProp(event, start, end, selected) // format title HH:MM - HH:MM : title
