...
var _TimeGridEventRoster = _interopRequireDefault(
  require('./TimeGridEventRoster')
)
  ...
  (function(_React$Component) {
    ...
    _proto.render = function render() {
      ...
      events.map(function(event) {
        ...
        var equalTime =
          _dates.default.hours(evtEnd) === _dates.default.hours(max) &&
          _dates.default.minutes(evtEnd) === _dates.default.minutes(max)
