...
var _DayColumnRoster = _interopRequireDefault(require("./DayColumnRoster"));

var _TimeGutterRoster = _interopRequireDefault(require("./TimeGutterRoster"));

var _width = _interopRequireDefault(require("dom-helpers/query/width"));

var _TimeGridHeaderRoster = _interopRequireDefault(require("./TimeGridHeaderRoster"));
...
/*#__PURE__*/
function (_Component) {
  (0, _inheritsLoose2.default)(TimeGridRoster, _Component);

  function TimeGridRoster(props) {
    var _this;
  ...
  var _proto = TimeGridRoster.prototype;
  ...
  _proto.renderEvents = function renderEvents(range, events, now) {
    ...
    return this.resources.map(function (_ref, i) {
      ...
      return range.map(function (date, jj) {
        ...
        return _react.default.createElement(_DayColumnRoster.default, (0, _extends2.default)({}, _this2.props, {
          localizer: localizer,
  ...
  _proto.render = function render() {
    ...
    var allEventsInRange = []; // events.forEach(event => {
    ...
    allEventsInRange.sort(function (a, b) {
    ...
    }, _react.default.createElement(_TimeGridHeaderRoster.default, {
      range: range,
    ...
    }, _react.default.createElement(_TimeGutterRoster.default, {
      date: start,
      ref: this.gutterRef,
      localizer: localizer,
  ...
  return TimeGridRoster;
}(_react.Component);

exports.default = TimeGridRoster;
TimeGridRoster.propTypes = {
