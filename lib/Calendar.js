...
function (_React$Component) {
  ...
  _proto.render = function render() {
    var _this$props4 = this.props,
        ...
        classNameCustom = _this$props4.classNameCustom,
        ...
        props = (0, _objectWithoutPropertiesLoose2.default)(_this$props4, ["view", "toolbar", "events", "style", "className", "classNameCustom", "elementProps", "date", "getNow", "length", "showMultiDayTimes", "components", "formats", "messages", "culture"]);
    ...
    return _react.default.createElement("div", (0, _extends2.default)({}, elementProps, {
      className: (0, _classnames.default)(className, "" + classNameCustom, props.rtl && 'rbc-is-rtl'),
      style: style
