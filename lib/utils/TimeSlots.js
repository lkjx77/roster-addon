...
function getSlotMetrics(_ref) {
  ...
  return {
    ...
    getRange: function getRange(rangeStart, rangeEnd, ignoreMin, ignoreMax) {
      ...
      if (!ignoreMin) rangeStart = _dates.default.min(end, _dates.default.max(start, rangeStart));
      if (!ignoreMax) rangeEnd = _dates.default.min(end, _dates.default.max(start, rangeEnd));
