...
var dates = (0, _extends2.default)({}, _dateArithmetic.default, {
  ...
  getTimeHHMM: function getTimeHHMM(date) {
    return _dateArithmetic.default.hours(date) + ":" + _dateArithmetic.default.minutes(date);
  },
  inRangeTest: function inRangeTest(start, end, timeSlotStart, timeSlotEnd) {
